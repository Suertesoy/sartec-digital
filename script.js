...
const I18N = {
  pt: {
    ...
    whatCanBeDeliveredTag: `O que pode ser entregue`,
    whatCanBeDeliveredHeading: `Os blocos que formam cada solução`,
    whatCanBeDeliveredIntro: `Cada solução combina alguns desses blocos. Veja o que pode ser entregue e o que pode ser combinado.`,
  ...
  en: {
    ...
    whatCanBeDeliveredTag: `What can be delivered`,
    whatCanBeDeliveredHeading: `The building blocks behind each solution`,
    whatCanBeDeliveredIntro: `Each solution combines some of these blocks. See what can be delivered and what can be combined.`,
