...
const I18N = {
  pt: {
    ...
    waGeneral: `Olá, vim pelo site da L A Cabral e quero conversar sobre minha operação.`,
    ...
    heroMicro: `Conversa direta com quem conduz a L A Cabral — sem formulário, sem intermediário.`,
    ...
    projectsShowcaseHeading: `Projetos que mostram como pensamos.`,
    projectsShowcaseDesc: `De um redesign completo a um produto desenhado do zero — a L A Cabral parte do problema, não do formato da entrega.`,
    ...
    proj3Desc: `Novo site institucional em desenvolvimento para o Grupo Almeida, com identidade própria e estrutura pensada para apresentar a operação e facilitar o primeiro contato.`,
    proj3Cta: `Protótipo em breve`,
    proj3FrameNote: `Site em construção`,
    ...
    caseChallengeLabel: `Desafio`,
    caseSolutionLabel: `Solução`,
    caseResultLabel: `Resultado`,
    caseCapabilitiesLabel: `Capacidades utilizadas`,

    caseSartecChallenge: `Com mais de 30 anos de operação e uma rotina sazonal pesada — principalmente na época de listas escolares —, a Sartec sempre dependeu de conversas manuais no balcão e no WhatsApp. Nos picos de demanda, pedidos chegavam por canais diferentes, sem organização entre quem perguntava, quem orçava e quem separava o material, e a direção não tinha visibilidade do andamento. O gargalo não era falta de site: era a ausência de um fluxo único entre a entrada do cliente, a triagem da demanda e a organização da equipe.`,
    caseSartecSolution: `Desenhamos um ecossistema conectado: um site que apresenta a operação e direciona por lista escolar, um canal único de WhatsApp, uma camada de IA para triagem inicial e um painel interno que organiza conversas, pedidos e responsáveis — as sete partes implementadas como um fluxo único, não como entregas separadas.`,
  ...
  en: {
    ...
    waGeneral: `Hi, I found you through the L A Cabral website and I'd like to talk about my operation.`,
    ...
    heroMicro: `A direct conversation with the person behind L A Cabral — no form, no middleman.`,
    ...
    projectsShowcaseHeading: `Projects that show how we think.`,
    projectsShowcaseDesc: `From a full redesign to a product designed from scratch — L A Cabral starts from the problem, not the shape of the deliverable.`,
    ...
    proj3Desc: `A new institutional website in development for Grupo Almeida, with its own identity and a structure designed to present the operation and streamline first contact.`,
    proj3Cta: `Prototype coming soon`,
    proj3FrameNote: `Website in progress`,
